...
if First_Sea or Second_Sea then
	local L_701_ = L_5_.Hop:AddSection("Third Sea Please !!!")
end
...
--info
L_5_.Info:AddButton({
          Title = "Credits From Toshy Hub!",
           Description = "The Script Developed By ToshyTeam",
            Callback = function()
                setclipboard("https://dsc.gg/toshyscript")
                Fluent:Notify(
                    {
                        Title = "Toshy Hub",
                        Content = "Developed With Love",
                        SubContent = "", -- Optional
                        Duration = 5 -- Set to nil to make the notification not disappear
                    }
                )
